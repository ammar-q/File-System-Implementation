...
struct ext2_block
{
	unsigned int addr[EXT2_ADDR_PER_BLOCK];
};
...
/*
 * Ext2 inode file types.  Highest 4 bits
 */
enum {
	EXT2_INODE_FT_FIFO			= 1,
	EXT2_INODE_FT_CHRDEV		= 2,
	EXT2_INODE_FT_DIR				= 4,
	EXT2_INODE_FT_BLKDEV		= 6,
	EXT2_INODE_FT_REG_FILE	= 8,
	EXT2_INODE_FT_SYMLINK		= 10,
	EXT2_INODE_FT_SOCK			= 12
};
